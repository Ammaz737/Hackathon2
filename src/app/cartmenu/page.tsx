...
import { getCartItems, removeFromCart, updateCartQuantity } from "../actions/actions"; // Assuming this is where you're managing cart items
...
interface Product {
  ...
  imageUrl: string;
  inventory: number;
  quantity: number;  // Added to track the quantity of the product in the cart
}
